...
<div class="row">
  <div class="page-title">
    <div class="title_left">
      <h4> Shortlisting
    <a href="{{ route('shortlistingtable') }}" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="For Easy Shortlisting Click Here">Easy Shortlisting <i class="fa fa-table"></i></a>
      </h4>
    </div>
  </div> 
</div>
<div class="x_panel">
  <form action="{{ route('shortlistingfilter') }} " method="post"  enctype="multipart/form-data">
  ...
  <a href="{{ route('shortlisting') }}" class="btn btn-primary buttonpostioncustom2">All Applicants</a>
  ...
  @foreach ( $applicants as $applicant)
   <div  class="row">
    ...
    <a href="{{ route('unshortlist',['id'=>$applicant->id]) }}" class="btn btn-warning btn-md btn-block"> <i class="fa fa-check"></i>Reset</a>


      @else
      <a href="{{ route('marktoshortlist',['id'=>$applicant->id]) }}" class="btn btn-success btn-md btn-block">Mark To Shortlist</a>
      @endif
    </div>
    <div class="col-md-3 col-sm-3 col-xs-1 customcontentpostion">
    ...
    <a href="{{ route('unshortlist',['id'=>$applicant->id]) }}" class="btn btn-warning btn-md btn-block"> <i class="fa fa-check"></i>Reset</a>
      ...
      @else
      <a href="{{ route('notshortlist',['id'=>$applicant->id]) }}" class="btn btn-danger btn-md btn-block">Not Shortlisted</a>
      @endif
