...
<div id="cv" class="instaFade" style="background: white;">
  <div class="mainDetails">
    <div  class="quickFade" style="display: flex;">
      <img src="{{ asset('images') }}/157010307151117799.png" alt="Alan Smith" width="70" height="70" />
...
<p style="padding-left: 30px; text-align: left;">&nbsp;</p>
<p style="padding-left: 30px; text-align: left;">I am pleased to extend a job offer for the position of &ldquo;{{-- {{$viewcontract->applicantcontract->getdesignation->designation }} --}}&rdquo; at SBSS to commence on {{ $viewcontract->reportingdate }} . You will be in a full time, at-will employment reporting to CEO SBSS. Your contract will expire after {{ $viewcontract->contractduration }}.</p>
<p style="padding-left: 30px; text-align: left;">&nbsp;</p>
