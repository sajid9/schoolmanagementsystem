...
<div class="row">
  <div class="page-title">
    <div class="title_left">
      <h4> Shortlisting
    <a href="<?php echo e(route('shortlistingtable')); ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="For Easy Shortlisting Click Here">Easy Shortlisting <i class="fa fa-table"></i></a>
      </h4>
    </div>
  </div> 
</div>
<div class="x_panel">
  <form action="<?php echo e(route('shortlistingfilter')); ?> " method="post"  enctype="multipart/form-data">
  ...
  <a href="<?php echo e(route('shortlisting')); ?>" class="btn btn-primary buttonpostioncustom2">All Applicants</a>
  ...
  <?php $__currentLoopData = $applicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <div  class="row">
    ...
    <a href="<?php echo e(route('unshortlist',['id'=>$applicant->id])); ?>" class="btn btn-warning btn-md btn-block"> <i class="fa fa-check"></i>Reset</a>


      <?php else: ?>
      <a href="<?php echo e(route('marktoshortlist',['id'=>$applicant->id])); ?>" class="btn btn-success btn-md btn-block">Mark To Shortlist</a>
      <?php endif; ?>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-1 customcontentpostion">
    ...
    <a href="<?php echo e(route('unshortlist',['id'=>$applicant->id])); ?>" class="btn btn-warning btn-md btn-block"> <i class="fa fa-check"></i>Reset</a>
      ...
      <?php else: ?>
      <a href="<?php echo e(route('notshortlist',['id'=>$applicant->id])); ?>" class="btn btn-danger btn-md btn-block">Not Shortlisted</a>
      <?php endif; ?>
    
    </div>
    <div class="col-md-3 col-sm-3 col-xs-1 customcontentpostion">
      <?php if($applicant->is_shortlist=="yes"): ?>
   <p class="mycustomalert" style="background: #26B99A;"><strong>Status: </strong>Aplicant into Shortlist</p>
<?php elseif($applicant->is_shortlist=="no"): ?>
    <p class="mycustomalert" style="background: #D9534F;"><strong>Status: </strong>Aplicant into Not Shortlist </p>
<?php else: ?>
     <p class="mycustomalert" style="background: #F0AD4E;"><strong>Status:</strong>No Status Found Yet</p>
<?php endif; ?>
