   ...
   <div class="col-lg-12">
     <div class="panel panel-default">
       <div class="panel-heading">
                Results
         <a href="<?php echo e(url('/results')); ?>" type="button" class="btn btn-primary btn-sm pull-right">Add Result</a>      
       </div>
            <!-- /.panel-heading -->
         <div class="panel-body">
           <div class="table-responsive">
             ...
             <!--   -->
							...
							<td>
                <a href="<?php echo e(url('editResults/'.$result->id)); ?>">
                  <i class="fa fa-edit"></i>
                </a>
                <a href="<?php echo e(url('delResults/'.$result->id)); ?>">
