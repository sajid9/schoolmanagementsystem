...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3>Edit Result</h3>
            <form class="form-group row" role="form" method="post" action="<?php echo e(url('updateResults')); ?>"  enctype="multipart/form-data">
                ...
                <div class="col-md-4"> 
                    ...
                    <select custom class="form-control" name="admission_id" id="regStd" required="required">
                        ...
                        <option value="<?php echo e($admission->id); ?>" <?php echo e(( $admission->id == $results->admission_id) ? 'selected':''); ?>><?php echo e($admission->registrations->firstName); ?> / <?php echo e($admission->gfirstName); ?> / <?php echo e($admission->rollnumber); ?></option>
                   ...
                   <div class="form-group">
                    ...
                    <select custom class="form-control" name="examSchedule_id" id="" required="required">
                        ...
                        <option value="<?php echo e($examSchedule->id); ?>"  <?php echo e(( $examSchedule->id == $results->examSchedule_id) ? 'selected':''); ?>><?php echo e($examSchedule->batches->classes->c_name); ?> / <?php echo e($examSchedule->subjects->sub_name); ?> / <?php echo e($examSchedule->examTerms->examTermName); ?></option>
                    ...
                    <input name="total_marks" class="form-control" value="<?php echo e($results->total_marks); ?>" required="required" placeholder="Enter Total Marks">
                    </div>

                    <div class="form-group">
                    <label>Obtained Marks<span style="color: red" class="required">*</span></label>
                    <input name="obtain_marks" class="form-control" value="<?php echo e($results->obtain_marks); ?>" required="required" placeholder="Enter Obtained Marks">
                    </div>
                    
                    <div class="form-group">
                    <label>Passing Marks<span style="color: red" class="required">*</span></label>
                    <input name="pass_marks" class="form-control" value="<?php echo e($results->pass_marks); ?>" required="required" placeholder="Enter Passing Marks">
                    </div>
                    ...
                    <select custom class="form-control" name="grade_id" required="required">
                        ...
                        <option value="<?php echo e($grade->id); ?>" <?php echo e(( $grade->id == $results->grade_id) ? 'selected':''); ?>><?php echo e($grade->grade_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    </div>
