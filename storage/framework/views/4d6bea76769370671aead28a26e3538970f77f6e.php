            ...
            <form class="form-group row" role="form" method="post" action="<?php echo e(url('updateExamSchedule')); ?>"  enctype="multipart/form-data">
                ...
                <div class="col-md-4"> 
                    ...
                    <select custom class="form-control" name="batch_id" required="required">
                        ...
                        <option <?php echo e(($examSchedules->batch_id == $batch->id) ?'selected':''); ?> value="<?php echo e($batch->id); ?>"><?php echo e($batch->batchName); ?> / <?php echo e($batch->classes->c_name); ?> / <?php echo e($batch->sections->sec_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    </div>
                    <div class="form-group">
