...
<a href="<?php echo e(route('shortlisting')); ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="For Detail Shortlisting Click Here">Switch to Detail Shortlisting </a>
    </h3>
  </div>
</div>
</div>
    ...
    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          <?php $__currentLoopData = $applicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <td> 
              <a  href="<?php echo e(route('shortlistingtableview',['id'=> $applicant->id])); ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" data-placement="top" title="view Applicants"><i class="fa fa-eye"></i></a>

              <a  href="<?php echo e(route('marktoshortlist',['id'=>$applicant->id])); ?>"class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="Mark into Shortlist"><i class="fa fa-check"></i></a>
