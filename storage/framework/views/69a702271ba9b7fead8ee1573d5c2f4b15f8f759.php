...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form class="form-horizontal form-label-left" action="<?php echo e(route('updateapplicantdesignation')); ?>" method="post">
        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        <input type="hidden" name="d_id" value="<?php echo e($applicantdesignation->id); ?>">
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12">Designation</label>
          <div class="col-md-9 col-sm-9 col-xs-12">
         <input type="text" name="designation" class="form-control" placeholder="Designation Name" value="<?php echo e($applicantdesignation->designation); ?>">
