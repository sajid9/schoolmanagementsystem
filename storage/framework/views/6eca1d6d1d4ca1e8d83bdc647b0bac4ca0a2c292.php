        ...
        <div class="col-lg-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="hidden" name="id" value="<?php echo e($cenrolls->id); ?>">
                    ...
                    <select custom class="form-control" name="admission_id" id="regStd" required="required">
                        ...
                        <option value="<?php echo e($admission->id); ?>" <?php echo e(( $admission->id == $cenrolls->admission_id) ? 'selected':''); ?>><?php echo e($admission->registrations->firstName); ?></option>
                ...
                <div class="checkbox">
                    <label>
                    <input type="checkbox" data-toggle="toggle" name="is_active" value="yes" <?php echo e(($cenrolls->is_active == 'yes') ? 'checked' : ''); ?> data-on="Active" data-off="Inactive">
                    </label>
                </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input id="gfirstName" name="gfirstName" class="form-control" placeholder="Enter First Name" value="<?php echo e($cenrolls->gfirstName); ?>" required="required">
                </div>
                <div class="form-group">
                    <label>Date of Birth<span style="color: red" class="required">*</span></label>
                    <input type="Date" id="dateBirth" name="dateBirth" class="form-control" value="<?php echo e($cenrolls->dateBirth); ?>" placeholder="Enter Date of Birth" required="required">
                </div>
            </div>
