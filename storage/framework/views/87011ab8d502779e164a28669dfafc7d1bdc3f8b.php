...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form role="form" method="post" action="<?php echo e(url('addExamSchedule')); ?>">
             <?php echo e(csrf_field()); ?>
                ...
                <div class="col-md-4">
                    ...
                    <select custom class="form-control" name="examSlot_id" id="" required="required">
                        ...
                        <option value="<?php echo e($examSlot->id); ?>"> <?php echo e($examSlot->classRooms->cRoom_name); ?> / <?php echo e($examSlot->days->day_name); ?> / <?php echo e($examSlot->examTimes->examTimeName); ?> / <?php echo e($examSlot->slot_date); ?></option>
                    ...
                    <select custom class="form-control" name="batch_id" required="required">
                        ...
                        <option value="<?php echo e($batch->id); ?>"><?php echo e($batch->batchName); ?> / <?php echo e($batch->classes->c_name); ?> / <?php echo e($batch->sections->sec_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <select custom class="form-control" name="examTerm_id" required="required">
                        ...
                        <option value="<?php echo e($examTerm->id); ?>"><?php echo e($examTerm->examTermName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    </div>
