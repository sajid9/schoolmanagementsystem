...
<form action="<?php echo e(route('insertapplicant')); ?> " method="post"  enctype="multipart/form-data">
        ...
        <div class="form-horizontal form-label-left">
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="name" class="form-control col-md-7 col-xs-12"  name="name" placeholder="both name(s) e.g Jon Doe" type="text" value="<?php echo e(old('name')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text"    name="cnic"class="form-control" data-inputmask="'mask' : '99999-9999-999-9'" value="<?php echo e(old('cnic')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="fname" class="form-control col-md-7 col-xs-12"  name="fname" placeholder="Father Name"   type="text" value="<?php echo e(old('fname')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <div class="input-group date customdatepicker" id="mydob">
                <input type="text" class="form-control" name="dob" value="<?php echo e(old('dob')); ?>" >
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <textarea id="address"    name="address" class="form-control col-md-7 col-xs-12"></textarea value="<?php echo e(old('address')); ?>">
      ...
      <div class="col-md-6 col-sm-6 col-xs-6">
        <div class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text"    name="mobile" class="form-control" data-inputmask="'mask' : '9999-9999999'" value="<?php echo e(old('mobile')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" name="ptcl" class="form-control" data-inputmask="'mask' : '999-9999999'" value="<?php echo e(old('ptcl')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="number"  name="weight"  min="0" class="form-control" id="weight" value="<?php echo e(old('weight')); ?>" placeholder="0.00">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="number"   name="height" min='0' placeholder="0.00" class="form-control" id="height" value="<?php echo e(old('height')); ?>">
