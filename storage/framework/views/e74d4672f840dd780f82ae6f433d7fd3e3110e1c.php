...
<div class="panel-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <form class="form-group row" role="form" method="post" action="<?php echo e(url('admitStudents')); ?>"            enctype="multipart/form-data">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select custom class="form-control" name="registration_id" id="regStd" required="required">
                        ...
                        <option value="<?php echo e($reg->id); ?>"><?php echo e($reg->firstName); ?></option>
                ...
                <div class="form-group">
                    ...
                    <input type="Date" name="admissionDate" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" required="required">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <!--  <p class="help-block color-red" ><?php echo e($errors->first('nationality')); ?></p>-->
                </div>
                <div class="form-group">
                    <label>Mother Tongue</label>
                    <input name="tongue" class="form-control" placeholder="Enter Mother Tongue">
                  <!--  <p class="help-block color-red" ><?php echo e($errors->first('tongue')); ?></p>-->
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                   ...
                   <!-- <p class="help-block color-red" ><?php echo e($errors->first('religion')); ?></p>-->
                </div>
